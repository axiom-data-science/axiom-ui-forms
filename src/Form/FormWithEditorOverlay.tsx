...
import {
  ...
  useFormContext,
  useFormValues,
} from ***REMOVED***@/Form/Creator/FormContextProvider***REMOVED***
import {
  CheckIcon,
  CopyIcon,
  Cross2Icon,
  ...
  return (
    <div className="py-20">
      <CopyButton
        ...
        ToCopyElement={
          <>
            <CopyIcon className=" inline" /> Copy form output
          </>
        }
      />
    </div>
...
const FormEditor = ({ children }: { children: ReactNode }): ReactElement => {
...
const SchemaFormWithEditorOverlay = ({
  ...
  const [fieldOverridesInput, setFieldOverridesInput] =
    fieldOverrideState ?? useState<IFormFieldOverride[]>([])
  const [formOverrideInput, setFormOverrideInput] =
    formOverrideState ?? useState<IFormOverride | undefined>(undefined)
  const [layout] = useAtom(layoutAtom)

  const formOverrides = formOverrideInput !== undefined ? [formOverrideInput] : undefined
  const formFieldOverrides = [rootFieldOverridesInput, fieldOverridesInput].filter(
    (o) => o !== undefined
  )
                  ...
                  tabs={[
                    {
                      ...
                      content: (
                        <JSONInput
                          value={
                            formOverrideInput !== undefined
                              ? JSON.stringify(formOverrideInput, null, 2)
                              : ***REMOVED******REMOVED***
                          }
                          onChange={(e) => {
                            setFormOverrideInput(
                              e !== undefined ? (e as unknown as IFormOverride) : undefined
                            )
                          }}
                          field={{
                    ...
                    setFieldOverridesInput !== undefined
                      ? {
                          ...
                          content: (
                            <JSONInput
                              value={
                                fieldOverridesInput !== undefined
                                  ? JSON.stringify(fieldOverridesInput, null, 2)
                                  : ***REMOVED******REMOVED***
                              }
                              onChange={(e) => {
                                setFieldOverridesInput(
                                  e !== undefined ? (e as unknown as IFormFieldOverride[]) : []
                                )
                              }}
                              field={{
                    ...
                    setRootFieldOverridesInput !== undefined
                      ? {
                          ...
                          content: (
                            <JSONInput
                              value={
                                rootFieldOverridesInput !== undefined
                                  ? JSON.stringify(rootFieldOverridesInput, null, 2)
                                  : ***REMOVED******REMOVED***
                              }
                              onChange={(e) => {
                                setRootFieldOverridesInput(
                                  e !== undefined ? (e as unknown as IFormFieldOverride[]) : []
                                )
                              }}
                              field={{
                      ...
                      : undefined,
                    {
                      ...
                      content: (
                        <FormOutput
                          form={
                            formOverrides === undefined && formFieldOverrides === undefined
