...
import { Pencil, X, ListStart, ListEnd, ChevronDown, ChevronRight } from ***REMOVED***lucide-react***REMOVED***
...
const FieldNodeRow = ({
  ...
  const fieldColor = mapped ? ***REMOVED***border-emerald-300 bg-emerald-50***REMOVED*** : ***REMOVED***border-amber-300 bg-amber-50***REMOVED***
  ...
  return (
    <div className="flex items-center gap-2 w-full">
      ...
      >
        ...
        <div className="flex flex-col min-w-0 flex-1 gap-0.5">
          <div className="flex items-center gap-1.5 min-w-0">
            ...
            <span className="text-xs text-slate-500 truncate min-w-0">
              {field.prop.trim() !== ***REMOVED******REMOVED*** ? field.prop : ***REMOVED***(unmapped field)***REMOVED***}
            </span>
          </div>
          <div className="flex items-center gap-1.5 min-w-0">
            <select
        ...
        <span
          className={`text-[11px] px-2 py-0.5 rounded ${mapped ? ***REMOVED***bg-emerald-200 text-emerald-800***REMOVED*** : ***REMOVED***bg-amber-200 text-amber-900***REMOVED***}`}
        >
      ...
      <div className="inline-flex items-center gap-0.5 shrink-0">
        {canToggleChildren ? (
          <Tooltip
            dark={true}
            content={isChildrenCollapsed ? ***REMOVED***Expand nested fields***REMOVED*** : ***REMOVED***Collapse nested fields***REMOVED***}
            side="top"
            useSpan={true}
          >
