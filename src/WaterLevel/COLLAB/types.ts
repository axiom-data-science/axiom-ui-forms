export interface IMetadataField {
  ...
  response_type:
    | ***REMOVED***Text-short***REMOVED***
    | ***REMOVED***Text-long***REMOVED***
    | ***REMOVED***Text***REMOVED***
    | ***REMOVED***Date***REMOVED***
    | ***REMOVED***Multichoice***REMOVED***
  ...
  ***REMOVED***CO-OPS Spec***REMOVED***: ***REMOVED***R***REMOVED*** | ***REMOVED***O***REMOVED*** | ***REMOVED***N***REMOVED*** | string | null
  SECOORA: ***REMOVED***R***REMOVED*** | ***REMOVED***O***REMOVED*** | ***REMOVED***N***REMOVED*** | string | null
  NERACOOS: ***REMOVED***R***REMOVED*** | ***REMOVED***O***REMOVED*** | ***REMOVED***N***REMOVED*** | string | null
  ***REMOVED***CO-OPS***REMOVED***: ***REMOVED***R***REMOVED*** | ***REMOVED***O***REMOVED*** | ***REMOVED***N***REMOVED*** | string | null
  AOOS: ***REMOVED***R***REMOVED*** | ***REMOVED***O***REMOVED*** | ***REMOVED***N***REMOVED*** | string | null
  CARICOOS: ***REMOVED***R***REMOVED*** | ***REMOVED***O***REMOVED*** | ***REMOVED***N***REMOVED*** | string | null
